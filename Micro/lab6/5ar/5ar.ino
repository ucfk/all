...
void checkSwitches() {
  ...
  if (c==3) {
      ...
      digitalWrite(l3, !sw3);
      digitalWrite(l4, !sw4);
      if (sw1 == 0) Display_1Digit_7Segment(0);
      if (sw2 == 0) Display_1Digit_7Segment(1);
      if (sw3 == 0) Display_1Digit_7Segment(2);
      if (sw4 == 0) Display_1Digit_7Segment(3);
  }
